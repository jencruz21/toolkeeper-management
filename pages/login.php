              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome to QR Based Toolkeeper Management System</h1>
                  </div>
                  <form class="user" role="form" action="processlogin.php" method="post">
                    ...
                    <a class="btn btn-primary btn-user btn-block" href="login_qrcode.php">Login with QR Code</a>
                    <hr>
                  <!-- <div class="text-center">
