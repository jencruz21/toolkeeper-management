...
#text{
  ...
  <title>Approaval</title>
  <link rel="icon" href="https://www.freeiconspng.com/img/8054">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="pos.php" role="button">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Releasing</span>
              </a>
            </li>
              ...
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php
                  if($_SESSION['GENDER']=='Male'){
                    echo 'src="https://www.freeiconspng.com/uploads/large-user-icon-26.gif"';
                  }else{
